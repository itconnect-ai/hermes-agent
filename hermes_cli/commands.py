...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ping", "Check gateway responsiveness without a model call", "Info",
               gateway_only=True),
    CommandDef("queue-status", "Show provider-account queue status", "Info",
               gateway_only=True, aliases=("queues",)),
